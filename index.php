...
<title>Welcome to Bhardwaj Travells </title>
...
<div id="wrapper">
    ...
    <div id="content">
    	<div id="rotator">
              <ul>
                    <li class="show"><img src="xres/images/jb2/bus01.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/bus02.jpg" width="861" height="379"  alt="" /></li>
    ...
    <div id="featured">
        <div id="items">
            ...
            <p><a href="lodging.php"><strong>From Banglore to Pune</strong><br />
			Spend a relaxing evening in our Golds-17  hotel. </a></p>
			</div>
			<div class="item" style="width: 860px;"> 
				<iframe src="//www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2Fpages%2FFlorida-Bus%2F224961217554604%3Fref%3Dts%26fref%3Dts&amp;width=800&amp;height=290&amp;show_faces=true&amp;colorscheme=dark&amp;stream=false&amp;border_color&amp;header=true" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:800px; height:100px;" allowTransparency="true"></iframe>
			</div>
        </div>
    </div>

	<div id="footer">
	<h4>+8147136986 &bull; <a href="contact-us.php">Bhavuk Bhardwaj, BIET, Davangere, Karnataka  </a></h4>
	<p>Hours of Operation&nbsp;&nbsp;&bull;&nbsp;&nbsp;Mon - Sun: 10:00 am - 12:00 am</p>
	<p>&copy; Copyright 2018 Bhardwaj Bus | All Rights Reserved <br /></p>
</div>
</div>
</body>
</html>
